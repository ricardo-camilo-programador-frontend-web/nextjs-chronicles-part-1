  ...
  const renderPaymentMethod = () => {
    ...
    switch (order.paymentInfo.paymentMethod) {
      case "creditCard":
        return (
          <div className="bg-surface p-6 rounded-lg text-center">
            <FaCreditCard className="text-4xl mx-auto mb-4 text-success" />
      ...
      case "bitcoin":
        return (
          <div className="bg-surface p-6 rounded-lg text-center">
            <div className="bg-surface p-4 rounded-lg inline-block mx-auto mb-4">
        ...
        return (
          <div className="bg-surface p-6 rounded-lg text-center">
            <a
              ...
              className="inline-block bg-success hover:bg-success/90 text-foreground px-6 py-3 rounded-lg"
            >
              {t("downloadBoleto")}
            </a>
          </div>
        ...
        return (
          <div className="bg-surface p-6 rounded-lg text-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block bg-info hover:bg-info/90 text-foreground px-6 py-3 rounded-lg"
            >
              {t("proceedToPayPal")}
            </a>
          </div>
          ...
          <div className="container mx-auto px-4 py-8 max-w-4xl z-10 text-foreground">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-6">
                <div className="space-y-4 bg-surface backdrop-blur-md rounded-lg p-4 border border-surface-border">
              ...
              <div className="space-y-4 bg-glass backdrop-blur-md rounded-lg p-4 border border-glass-border">
                ...
                <div className="bg-surface backdrop-blur-md rounded-lg">
                  {renderPaymentMethod()}
                </div>
              </div>
            </div>

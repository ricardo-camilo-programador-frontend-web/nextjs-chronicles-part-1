...
export const LanguageSwitcher: FC<Props> = ({ className }) => {
  ...
  return (
    <div
      className={`relative text-left inline-block ${className}`}
      ref={menuRef}
    >
      <button
        type="button"
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 origin-top-right rounded-md bg-primary shadow-lg ring-1 ring-foreground/10 animate-dropdown focus:outline-none">
